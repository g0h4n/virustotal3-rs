...
/// ```
/// 
/// More informations here: [`vtClient::url`](../struct.VtClient.html)
pub mod url;
...
/// ```
/// 
/// More informations here: [`vtClient::ip`](../struct.VtClient.html)
pub mod ip;
...
/// ```
/// 
/// More informations here: [`vtClient::file`](../struct.VtClient.html)
pub mod file;
...
/// ```
/// 
/// More informations here: [`vtClient::comment`](../struct.VtClient.html)
pub mod comment;
...
impl <'a>VtClient<'a> {
    pub fn new(api_key: &'a str) -> Self {
        VtClient{api_key: api_key, endpoint: "https://www.virustotal.com/api/v3"}
    }
}